...
use Gmponos\GuzzleLogger\Middleware\LogMiddleware;
...
final class LogMiddlewareTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var MockHandler
     */
    ...
    private function createClient(array $options = [])
    {
        ...
        $stack->unshift(new LogMiddleware($this->logger));
        return new Client(
            array_merge([
                'handler' => $stack,
            ], $options)
